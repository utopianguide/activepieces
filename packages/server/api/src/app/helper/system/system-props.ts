...
export enum AppSystemProp {
    ...
    LANGFUSE_EVALUATOR_API_KEY = 'LANGFUSE_EVALUATOR_API_KEY',
    LANGFUSE_EVALUATOR_BATCH_SIZE = 'LANGFUSE_EVALUATOR_BATCH_SIZE',
    LANGFUSE_EVALUATOR_ENABLED = 'LANGFUSE_EVALUATOR_ENABLED',
    LANGFUSE_EVALUATOR_INTERVAL_SECONDS = 'LANGFUSE_EVALUATOR_INTERVAL_SECONDS',
    LANGFUSE_EVALUATOR_MODEL = 'LANGFUSE_EVALUATOR_MODEL',
    LANGFUSE_EVALUATOR_PROVIDER = 'LANGFUSE_EVALUATOR_PROVIDER',
