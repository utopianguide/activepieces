...
const systemPropValidators: {
    ...
    [AppSystemProp.LANGFUSE_ENABLED]: booleanValidator,
    [AppSystemProp.LANGFUSE_EVALUATOR_API_KEY]: stringValidator,
    [AppSystemProp.LANGFUSE_EVALUATOR_BATCH_SIZE]: numberValidator,
    [AppSystemProp.LANGFUSE_EVALUATOR_ENABLED]: booleanValidator,
    [AppSystemProp.LANGFUSE_EVALUATOR_INTERVAL_SECONDS]: numberValidator,
    [AppSystemProp.LANGFUSE_EVALUATOR_MODEL]: stringValidator,
    [AppSystemProp.LANGFUSE_EVALUATOR_PROVIDER]: enumValidator(['anthropic', 'openai']),
    [AppSystemProp.LANGFUSE_PUBLIC_KEY]: stringValidator,
    [AppSystemProp.LANGFUSE_SECRET_KEY]: stringValidator,
    [AppSystemProp.LANGFUSE_HOST]: urlValidator,
